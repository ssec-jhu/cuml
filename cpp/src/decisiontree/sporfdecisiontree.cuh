...
// TODO: CHOP IF UNUSED: #include "batched-levelalgo/kernels/sporf_builder_kernels.cuh"
...
class SPORFDecisionTree {
  ...
  /* type (re)definition for this class implementation */
  using IdxT = unsigned long;

 public:
  template <class DataT, class LabelT>
  static std::shared_ptr<DT::ObliqueTreeMetaDataNode<DataT, LabelT>> fit(
  ...
  static void predict(const raft::handle_t& handle,
                      const DT::ObliqueTreeMetaDataNode<DataT, LabelT>& tree,
                      const DataT* rows,
                      std::size_t n_rows,
                      std::size_t n_cols,
                      DataT* predictions,
  ...
  template <class DataT, class LabelT>
  static void predict_all(const DT::ObliqueTreeMetaDataNode<DataT, LabelT>& tree,
                          const DataT* rows,
                          std::size_t n_rows,
                          std::size_t n_cols,
                          DataT* preds,
