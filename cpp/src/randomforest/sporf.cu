 ...
 * 
 *  In .../cuml/cpp/CMakeLists.txt, add a reference to this file:
 *
...
#endif // EXCLUDE_REDEFINITIONS


/**
 * @brief Deletes SPORFMetaData object
 * @param[in] forest: CPU pointer to SPORFMetaData.
 */
template <class T, class L>
void delete_rf_metadata(SPORFMetaData<T, L>* forest)
{
  delete forest;
}

template <class T, class L>
std::string _get_rf_text(const SPORFMetaData<T, L>* forest, bool summary)
{
  if (!forest) {
    return "Empty forest";
  } else {
...
template <class T, class L>
std::string _get_rf_json(const SPORFMetaData<T, L>* forest)
{
  if (!forest) { return "[]"; }
  std::ostringstream oss;
  oss << "[\n";
 ...
 * @param[in] forest: CPU pointer to SPORFMetaData struct.
 */
template <class T, class L>
std::string get_rf_summary_text(const SPORFMetaData<T, L>* forest)
{
 ...
 */
template <class T, class L>
std::string get_rf_detailed_text(const SPORFMetaData<T, L>* forest)
{
  return _get_rf_text(forest, false);
}

template <class T, class L>
std::string get_rf_json(const SPORFMetaData<T, L>* forest)
{
 ...
 * @param[in,out] forest: CPU pointer to SPORFMetaData object. User allocated.
...
void fit_treelite(const raft::handle_t& user_handle,
                  ...
                  rapids_logger::level_enum verbosity)
{
  SPORFMetaData<value_t, label_t> metadata;
  fit(user_handle,
      &metadata,
      input,
      n_rows,
...
/**
 * @defgroup SPORFRegressorFit Random Forest Regression - Fit function
...
void fit(const raft::handle_t& user_handle,
         ...
         bool* bootstrap_masks)
{
  dtPrint( "fit(float) (in sporf.cu LINE %d)", __LINE__ );
...
void fit(const raft::handle_t& user_handle,
         ...
         bool* bootstrap_masks)
{
  dtPrint( "fit(double) (in sporf.cu LINE %d)", __LINE__ );
...
void fit_treelite(const raft::handle_t& user_handle,
                  ...
                  rapids_logger::level_enum verbosity)
{
  dtPrint( "fit_treelite() (in sporf.cu LINE %d)", __LINE__ );
...
/**
 * @defgroup SPORFRegressorPredict Random Forest Regression - Predict function
...
/**
 * @defgroup SPORFRegressorScore Random Forest Regression - Score function
 ...
 */
template <class T, class L>
void compute_feature_importances(const SPORFMetaData<T, L>* forest, T* importances)
{
...
template std::string get_rf_summary_text<float, int>(const SPORFClassifierF* forest);
template std::string get_rf_summary_text<double, int>(const SPORFClassifierD* forest);
template std::string get_rf_summary_text<float, float>(const SPORFRegressorF* forest);
template std::string get_rf_summary_text<double, double>(const SPORFRegressorD* forest);

template std::string get_rf_detailed_text<float, int>(const SPORFClassifierF* forest);
template std::string get_rf_detailed_text<double, int>(const SPORFClassifierD* forest);
template std::string get_rf_detailed_text<float, float>(const SPORFRegressorF* forest);
template std::string get_rf_detailed_text<double, double>(const SPORFRegressorD* forest);

template std::string get_rf_json<float, int>(const SPORFClassifierF* forest);
template std::string get_rf_json<double, int>(const SPORFClassifierD* forest);
template std::string get_rf_json<float, float>(const SPORFRegressorF* forest);
template std::string get_rf_json<double, double>(const SPORFRegressorD* forest);

template void delete_rf_metadata<float, int>(SPORFClassifierF* forest);
template void delete_rf_metadata<double, int>(SPORFClassifierD* forest);
template void delete_rf_metadata<float, float>(SPORFRegressorF* forest);
template void delete_rf_metadata<double, double>(SPORFRegressorD* forest);

template void build_treelite_forest<float, int>(TreeliteModelHandle* model,
                                                const SPORFMetaData<float, int>* forest,
                                                int num_features);
template void build_treelite_forest<double, int>(TreeliteModelHandle* model,
                                                 const SPORFMetaData<double, int>* forest,
                                                 int num_features);
template void build_treelite_forest<float, float>(TreeliteModelHandle* model,
                                                  const SPORFMetaData<float, float>* forest,
                                                  int num_features);
template void build_treelite_forest<double, double>(
  TreeliteModelHandle* model, const SPORFMetaData<double, double>* forest, int num_features);

// Template instantiations for get functions
template void compute_feature_importances<float, int>(
  const SPORFMetaData<float, int>* forest, float* importances);
template void compute_feature_importances<double, int>(
  const SPORFMetaData<double, int>* forest, double* importances);
template void compute_feature_importances<float, float>(
  const SPORFMetaData<float, float>* forest, float* importances);
template void compute_feature_importances<double, double>(
  const SPORFMetaData<double, double>* forest, double* importances);
